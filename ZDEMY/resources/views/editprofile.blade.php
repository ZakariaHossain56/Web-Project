    ...
    <div class="logcontainer">
        <div class="card">
            <div class="inner-box" id="card">
                <div class="card-back">
                    <h2>Edit Profile</h2>
                    <form method="POST" action="/home/editprofile/{{auth()->user()->id}}" enctype="multipart/form-data">
                        ...
                        <input type="text" class="input-box" name="lastname" placeholder="Last Name"
                        ...
                        <input type="email" class="input-box" name="email" placeholder="Email Id"
                        ...
                        <div class="usericon" style="background: #1f2641; padding:10px;
                        border-radius:20px; margin-bottom:20px" >
                        <input type="file" name="icon" placeholder="Course icon" value="{{ $user->icon }}">
                        </div>
                        @error('icon')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror

                        <input type="hidden" name="role" value="{{ $user->role }}" id="selectedRole">
                        ...
                        <form onsubmit="return validateForm()">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <p onclick="changeButtonText('Teacher')">Teacher</>
                                    <p onclick="changeButtonText('Admin')">Admin</>
                                </div>
                            </div>
