    ...
    <div class="videoscontainer">
        ...
        <section class="enroll">
            ...
            <div class="topnav" id="myTopnav">
                ...
                <a href="/home/enroll/{{ $course->id }}/coursevideos/review" class="active">Review</a>
            ...
            <div class="review">
                <div style="padding-left:16px">
                    ...
                    <form action="/home/enroll/{{ $course->id }}/coursevideos/review" method="POST"
                        class="contact__form">
                        @csrf

                        <div class="flex-container">
                            <input type="text" id="rate" name="rating" placeholder="Leave a rating" value="{{ old('rating') }}" required>
                            @error('rating')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                          @enderror

                            <input type="text" name="review" placeholder="write a review" value="{{ old('review') }}" required>
                    ...
                    <br><br>
                    <h3>All reviews in this course</h3>
                    <br><br>
                    ...
                    <div class="comm">
                        ...
                        <br>
                        @php
                        $rating = $review->rating; // Assuming $course is the object representing the course with a rating property
